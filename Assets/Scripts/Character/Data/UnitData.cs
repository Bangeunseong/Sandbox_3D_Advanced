...
namespace Character.Data
{
    [Serializable] public class UnitStat
    {
        ...
        [field: SerializeField] [field: Range(0f, 2000f)] public float Health { get; private set; } = 100f;
        [field: SerializeField] [field: Range(0f, 1500f)] public float BaseAttack { get; private set; } = 25f; 
        [field: SerializeField] [field: Range(0f, 1500f)] public float BaseDefense { get; private set; } = 15f;
        
        [field: SerializeField] [field: Range(0.5f, 15f)] public float BaseAttackRate { get; private set; } = 1f;
